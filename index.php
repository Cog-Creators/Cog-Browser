...
<html>
	<head>
		...
		<link href="https://fonts.googleapis.com/css2?family=Merienda&family=Roboto:wght@500&&display=swap" rel="stylesheet">
		...
		<div class="list">
			...
			<?php }else{ foreach($cog_chunks[$page - 1] as $cog){ ?>
				<div>
					...
					<?php } ?>
					<t><svg class="icon" viewBox="0 0 16 16">
					...
					</svg>cog install <?php print($cog['source_name']); ?> <?php print($cog['id']); ?></t>
